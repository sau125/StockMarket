...
namespace ExcelAPI.Migrations
{
    ...
    [Migration("20211217043505_migtn1")]
    partial class migtn1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExcelAPI.Entities.Company", b =>
                {
            ...
            modelBuilder.Entity("ExcelAPI.Entities.IPODetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ExcelAPI.Entities.Sectors", b =>
                {
                    b.Property<string>("SectorId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ExcelAPI.Entities.StockExchange", b =>
                {
            ...
            modelBuilder.Entity("ExcelAPI.Entities.StockPrice", b =>
                {
            ...
            modelBuilder.Entity("ExcelAPI.Entities.Company", b =>
                {
                    b.HasOne("ExcelAPI.Entities.StockPrice", "StockPrice")
                        .WithMany()
                        .HasForeignKey("CompanyCode");

                    b.HasOne("ExcelAPI.Entities.Sectors", "Sectors")
                        .WithMany()
            ...
            modelBuilder.Entity("ExcelAPI.Entities.IPODetails", b =>
                {
                    b.HasOne("ExcelAPI.Entities.Company", "Company")
                        .WithMany()
            ...
            modelBuilder.Entity("ExcelAPI.Entities.StockPrice", b =>
                {
                    b.HasOne("ExcelAPI.Entities.StockExchange", "StockExchange")
                        .WithMany()
